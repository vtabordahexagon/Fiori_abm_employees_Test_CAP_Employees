  ...
  function (Controller, JSONModel, Filter, FilterOperator, formatter) {
    ...
    return Controller.extend("fioriabmempleados.controller.Master", {
      ...
      onSearch: function (oEvent) {
        ...
        if (sFilter1) {
          aFilter.push(
            new Filter("firstName", FilterOperator.Contains, sFilter1)
          );
        }
        if (sFilter2) {
          aFilter.push(
            new Filter("lastName", FilterOperator.Contains, sFilter2)
          );
        }
        if (sFilter3) {
          aFilter.push(
            new Filter("position", FilterOperator.Contains, sFilter3)
          );
        }
      ...
      onCreatePress: function () {
        if (!this._oNewEmployeeDialog) {
          this._oNewEmployeeDialog = sap.ui.xmlfragment(
            "fioriabmempleados.view.fragments.NewEmployee",
            this
          );
        ...
        var oListBinding = oModel.bindList(
          ...
          undefined,
          undefined,
          { $$updateGroupId: "newEmployeeGroupId", $$groupId: "auto" }
        );
      ...
      onDeletePress: async function (oEvent) {
        ...
        let oEmailBindList = this.oModel.bindList(
          "/Emails",
          undefined,
          undefined,
          new Filter("employeeID_employeeID", FilterOperator.EQ, sEmployeeID)
        );
        ...
        let oPhoneBindList = this.oModel.bindList(
          "/Phones",
          undefined,
          undefined,
          new Filter("employeeID_employeeID", FilterOperator.EQ, sEmployeeID)
        ...
        sap.m.MessageToast.show(
          "Empleado y sus datos asociados eliminados con éxito"
        );
      },
      ...
      onEditPress: function (oEvent) {
        ...
        this._oEditEmployeeDialog = sap.ui.xmlfragment(
          "fioriabmempleados.view.fragments.EditEmployee",
          this
        );
